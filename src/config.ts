...
export const API_CONFIG: ApiConfig = {
  ...
  routes: [
    ...
    },
    {
      ...
      toolDescription: "Use this when you need to compare SEO across multiple pages (up to 10). Same analysis as seo_audit_page for each URL. Ideal for competitor analysis or sitemap auditing. Do NOT use for single URLs.",
      inputSchema: {
        type: "object",
        properties: {
